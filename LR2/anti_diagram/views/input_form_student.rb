...
require_relative 'C:\Users\kirya\RubymineProjects\RubyLabs\LR2\anti_diagram\controllers\input_form_student_controller.rb'
require_relative 'C:\Users\kirya\RubymineProjects\RubyLabs\LR2\anti_diagram\models\student_base.rb'
require 'win32api'

class InputFormStudent
  include Glimmer
    ...
    @root_container = window('Универ', 300, 150) {
      ...
      vertical_box {
        @student_form = form {
          ...
          fields = [[:last_name, 'Фамилия', false], [:first_name, 'Имя', false], [:dadname, 'Отчество', false], [:git, 'Гит', true], [:telegram, 'Телеграм', true], [:mail, 'Почта', true], [:telephone, 'Телефон', true]]
